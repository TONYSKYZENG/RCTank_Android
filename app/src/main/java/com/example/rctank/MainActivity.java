...
public class MainActivity extends AppCompatActivity
        implements BluetoothTerminal.BluetoothConnectionListener,
        BluetoothTerminal.BluetoothMessageListener{
    private EditText msgInput,statusText;
   ...
   // = new AtomicBoolean(true);  // 初始值为true
    ...
    void sendMessage(String msg){
        ...
        bluetoothTerminal.sendMessage(msg);
    }
    @Override
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  portInput = findViewById(R.id.portInput);
       ...
       // modeSpinner = findViewById(R.id.modeSpinner);
        //NetworkUtils.findAndSetHotspotDeviceIp(this, ipInput);
...
// To refresh the list later:
       // deviceReader.refreshDeviceList(btSpinner);
        ...
        CamBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                webView.setWebViewClient(new WebViewClient()); // 确保点击链接时不会离开应用
                // 允许加载HTTP内容
                WebSettings webSettings = webView.getSettings();

                String webUrl = "http://"+statusText.getText().toString();
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        deviceReader.onRequestPermissionsResult(requestCode, permissions, grantResults);

        if (requestCode == BluetoothDeviceReader.REQUEST_BLUETOOTH_PERMISSIONS) {
    ...
    // 实现 BluetoothConnectionListener 接口方法
    @Override
